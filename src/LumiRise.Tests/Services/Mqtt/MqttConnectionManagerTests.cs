...
public class MqttConnectionManagerTests
{
    ...
    private readonly Mock<ILogger<LumiRise.Api.Services.Mqtt.Implementation.MqttConnectionManager>> _loggerMock = new();

    [Fact]
    public void IsConnected_InitiallyFalse()
    {
        var manager = new LumiRise.Api.Services.Mqtt.Implementation.MqttConnectionManager(
            _loggerMock.Object, Options.Create(_options));
